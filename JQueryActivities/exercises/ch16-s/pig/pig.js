...
$(document).ready( () => {  
    ...
    $("#roll").click( () => {
        ...
        // the game object to display the name of the player whose turn
        // it is. Otherwise, set the value of the Total text box to the 
    ...
    $("#hold").click( () => {
        ...
        // variable.
        var winner = game.hold($("#score1"), $("#score2")).checkWinner();
        ...
        // the game object to display the name of the player whose turn
        // it is, and set the focus on the Roll button.  Otherwise, set the value 
        // of the result span element to indicate the name of the winner.
        if (winner === "none") { 
            $("#die").val( "0" );
            $("#total").val( "0" );
            game.changePlayer();
    ...
    $("#winning_total").text(game.winningTotal);
    $("#player1").focus();
}); // end ready()